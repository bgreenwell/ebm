...
This article is very much a work in progress and is subject to change!

TODO:

- [] Finish setup, EBM, and discussion sections
- [] Clean up package references
  * Make sure first call to each package if followed by a reference 
  * Use \\CRANpkg if necessary in first reference to packages on CRAN
- [] Clean up citations
- [] Address all TODOs and FIXMEs throughout article
- [] Check spelling
...
TODO: Briefly talk about setting up a Python environment, as well as the `install_interpret()` function.
...
We gave a brief introduction to EBMs and a detailed walk through of the new R interface provided by the \pkg{ebm} package.
