...
both competitive accuracy and explicit transparency and exact
...
\item
  ...
  regression, the identify function for ordinary regression with
  continuous outcomes, or Poisson deviance for modeling counts);
\item
