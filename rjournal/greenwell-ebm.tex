...
\item
  ...
  \item
    Use \textbackslash CRANpkg if necessary in first reference to
    packages on CRAN
  \end{itemize}
\item
  {[}{]} Clean up citations
...
TODO: Briefly talk about setting up a Python environment, as well as the
\texttt{install\_interpret()} function.
...
module, depending on the need. For more details on persisting a fitted
...
\begin{center}\includegraphics[width=1\linewidth]{greenwell-ebm_files/figure-latex/als-ebm-lassso-plot-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{greenwell-ebm_files/figure-latex/als-ebm-lasso-scale-1} \end{center}
...
{\centering \includegraphics[width=1\linewidth]{greenwell-ebm_files/figure-latex/bikeshare-parallel-1} 
...
We gave a brief introduction to EBMs and a detailed walk through of the
